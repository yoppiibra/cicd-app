...
def build_model() -> None:
    ...
    Return:
        None
    """
    logger.info('starting up model build pipeline')
    df = prepare_data()
    feature_names = [
        'area',
        'constraction_year',
...
def _get_x_y(
    ...
    """
    logger.info(f'identify X and y variable. X vars: {col_x} y var: {col_y}')
...
def _evaluation_model(
    ...
    logger.info(f'evaluation model performance Score= {model_score}')
    return model_score
